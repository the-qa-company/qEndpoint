...
function runtest {
    ...
    trap "echo 'killing EP';kill -KILL $HDT_EP_PID_MAP" EXIT
    trap "echo 'killing EP';kill -KILL $HDT_EP_PID_MAP; exit -1" INT SIGUSR1
    
    sleep 4
    
    cd ..
    cd bsbmtools
    for SIZE in 500000 1000000 2000000 5000000 10000000
    do
