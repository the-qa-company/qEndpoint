...
public class CompiledSail extends SailWrapper {
     ...
     *
     * @throws Exception
     *             see {@link org.eclipse.rdf4j.sail.lucene.LuceneSail#reindex()}
     */
    ...
    public static class CompiledSailCompiler {
         ...
         *
         * @param configRDFStream
         *            the rdf input stream
         * @param configRDFStreamFormat
         *            the rdf format of the stream
         * @param close
         *            if the compiler should close the stream after reading
         *
         * @return this
         *
         ...
         * <p>
         * <b> THIS METHOD ISN'T THE SAME AS {@link #withSourceSail(org.eclipse.rdf4j.sail.NotifyingSail)}, it will only
         * use the sail to read the config, not wrapping it!! </b>
         * </p>
         *
         * @param configSail
         *            the sail
         ...
         *
         * @throws IOException
         *             error while reading a file/stream
