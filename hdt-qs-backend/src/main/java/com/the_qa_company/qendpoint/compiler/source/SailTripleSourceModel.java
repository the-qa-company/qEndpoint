...
/**
 * implementation of {@link com.the_qa_company.qendpoint.compiler.TripleSourceModel} to query {@link org.eclipse.rdf4j.sail.Sail}
...
public class SailTripleSourceModel implements TripleSourceModel {
	...
	private class SailTripleSourceGetter implements TripleSourceGetter {
		...
		public CloseableIteration<Statement, SailCompiler.SailCompilerException> getStatements(Resource s, IRI p, Value o) {
			CloseableIteration<? extends Statement, SailException> it = sail.getConnection().getStatements(s, p, o, false);
