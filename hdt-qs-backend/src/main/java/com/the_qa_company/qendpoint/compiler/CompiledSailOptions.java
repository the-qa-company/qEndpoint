...
/**
 * Options loaded from the {@link com.the_qa_company.qendpoint.compiler.SailCompiler.SailCompilerReader}.
...
public class CompiledSailOptions {
	...
	void readOptions(SailCompiler.SailCompilerReader reader) {
		...
		rdf4jSplitUpdate = reader.searchPropertyValue(SailCompilerSchema.MAIN, SailCompilerSchema.RDF_STORE_SPLIT_STORAGE);
