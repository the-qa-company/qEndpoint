...
public class EmptyTripleSourceGetter implements TripleSourceGetter, TripleSourceModel {
	...
	@Override
	public CloseableIteration<Statement, SailCompiler.SailCompilerException> getStatements(Resource s, IRI p, Value o) throws SailCompiler.SailCompilerException {
