...
public interface SailFilter {
     ...
     *
     * @param op
     *            the context of the add (can be null)
     * @param subj
     *            the subject of the add statement
     * @param pred
     *            the predicate of the add statement
     * @param obj
     *            the object of the add statement
     * @param contexts
     *            the contexts of the add statement
     *
     ...
     *            if it should include the inferred
     *
