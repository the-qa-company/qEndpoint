...
/**
 * A class to combine 2
 * {@link com.the_qa_company.qendpoint.utils.sail.filter.SailFilter} with a
 * boolean operation
 *
...
public class OpSailFilter implements SailFilter {
	/**
	 * A basic
	 * {@link com.the_qa_company.qendpoint.utils.sail.filter.OpSailFilter.BiBoolFunction}
