...
/**
 * a wrapper to filter multiple sail with a {@link com.the_qa_company.qendpoint.utils.sail.filter.TypeSailFilter}.
 *
...
public class MultiTypeFilteringSail extends NotifyingSailWrapper implements LinkedSail<MultiTypeFilteringSail> {
     ...
     *
     * @param tripleSourceSail
     *            the source to put bellow all the typed sail
     * @param predicate
     *            the predicate to define the type of a subject
     * @param types
     *            the typed sail to redirect
     */
    ...
    public static class TypedSail extends SimpleLinkedSail<NotifyingSail> {
         ...
         *
         * @param sail
         *            the sail to redirect
         * @param type
         *            the type associate with this filtered sail
         * @param sailConsumer
         *            the consumer to define the base sail of the sail
         */
