...
public class PipedIterator<T> implements Iterator<T> {
    ...
    /**
     * Callback for the {@link #createOfCallback(com.the_qa_company.qendpoint.utils.PipedIterator.PipeCallBack)} method
     *
     * @param <T>
     *            the iterator type
     *
    ...
    public interface PipeCallBack<T> {
         ...
         *
         * @throws Exception
         *             any exception returned by the generator
         */
     ...
     *
     * @param e
     *            exception to call at the {@link #hasNext()} next call
     *
     * @throws PipedIteratorException
     *             in case of Interruption
     */
     ...
     *
     * @throws PipedIteratorException
     *             if the pipe got an error while closing or in case of Interruption
     */
    @Override
