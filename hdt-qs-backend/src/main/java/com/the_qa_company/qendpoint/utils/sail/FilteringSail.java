...
public class FilteringSail implements NotifyingSail, LinkedSail<FilteringSail> {
     ...
     *
     * @param onYesSail
     *            the sail if the filter returns true
     * @param sourceSail
     *            the sail if the filter returns false
     * @param filter
     *            the filter building method (if connection required)
     */
     ...
     *            the sail if the filter returns false
     * @param endSail
     *            a consumer to set the end sail of the onYesSail
     * @param filter
     *            the filter building method (if connection required)
     */
     ...
     *
     * @param connection
     *            the connection to build the filter
     *
     * @return filter
     */
