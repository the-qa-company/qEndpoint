 ...
 * {@link com.the_qa_company.qendpoint.utils.sail.builder.SailCompilerSchema#PARSED_STRING_DATATYPE}, it should be put
 * on a method returning a string and without parameters, the methods with this annotation would be called once the
 * {@link com.the_qa_company.qendpoint.utils.sail.builder.SailCompiler#registerDirObject(Object)} method is called.
 */
