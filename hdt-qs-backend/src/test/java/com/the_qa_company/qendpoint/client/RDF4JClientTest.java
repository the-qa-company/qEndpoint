...
public class RDF4JClientTest {
    ...
    public void setUpTestUser() {
        System.out.println("Tests port " + port);
        ...
        Update update = repo.getConnection().prepareUpdate(query);
        update.execute();
        ...
        while (resultSet.hasNext()) {
            BindingSet a = resultSet.next();
            assertEquals(a.getBinding("o").getValue().getClass(), SimpleLiteral.class);
        }
    }
