...
public class MergeMethodTest {
	...
	public void atLeastMethodTest() throws InterruptedException {
		...
		// test that we have the right count after and before an add (no
		// merging)
		assertSizeEquals(0);
		...
		{
			// test that we have the right count after and before an add (while
			// merging)
			assertSizeEquals(0);
		...
		// test that we have the right count after and before an add (after
		// merging)
