...
@Fork(value = 3, jvmArgs = { "-Xms32G", "-Xmx32G", "-XX:+AlwaysPreTouch" })
...
//@Fork(value = 1, jvmArgs = {"-Xms64G", "-Xmx64G", "-XX:+EnableDynamicAgentLoading", "-XX:+AlwaysPreTouch", "-XX:StartFlightRecording=delay=15s,duration=120s,filename=recording.jfr,method-profiling=max", "-XX:FlightRecorderOptions=stackdepth=2048", "-XX:+UnlockDiagnosticVMOptions", "-XX:+DebugNonSafepoints"})
