...
public class EndpointStoreEvaluationStrategyFactory extends DefaultEvaluationStrategyFactory {
	...
	public EvaluationStrategy createEvaluationStrategy(Dataset dataset, TripleSource tripleSource, EvaluationStatistics evaluationStatistics) {
		EvaluationStrategy strategy = new EndpointStoreEvaluationStrategy(tripleSource, dataset, getFederatedServiceResolver(),
	...
	public class EndpointStoreEvaluationStrategy extends DefaultEvaluationStrategy {
		public EndpointStoreEvaluationStrategy(TripleSource tripleSource, Dataset dataset, FederatedServiceResolver serviceResolver, long iterationCacheSyncTreshold, EvaluationStatistics evaluationStatistics, boolean trackResultSize) {
