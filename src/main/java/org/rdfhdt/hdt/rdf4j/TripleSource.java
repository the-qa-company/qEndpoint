...
public class TripleSource implements org.eclipse.rdf4j.query.algebra.evaluation.TripleSource {
  private static final Logger logger = LoggerFactory.getLogger(TripleSource.class);
  ...
  public TripleSource(HDT hdt, NativeStore nativeStore) {
