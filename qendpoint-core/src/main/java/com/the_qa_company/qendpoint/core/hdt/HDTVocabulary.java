 ...
 * HDTVocabulary.java $ Revision: $Rev: 191 $ Last modified: $Date: 2013-03-03
...
public class HDTVocabulary {
	...
	public static final String DICTIONARY_TYPE_MULT_SECTION_LANG_PREFIXES = HDT_DICTIONARY_BASE + "MultLangPrefixes>";
