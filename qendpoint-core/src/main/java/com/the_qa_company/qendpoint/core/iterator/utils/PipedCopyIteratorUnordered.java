...
public class PipedCopyIteratorUnordered<T> extends PipedCopyIterator<T> {
	...
	public boolean hasNext() {
		...
		if (obj.end()) {
			System.out.println("End of queue: " + counter.get());
			end = true;
			if (exception != null) {
				throw exception;
			}
	...
	private boolean isEnd() {
		for (AtomicBoolean atomicBoolean : queueEnd) {
	...
	public T next() {
		...
		if (i % 100 == 0 && i > 176451821) {
			System.out.println("PipedCopyIteratorUnordered: " + i);
		}
		T next = this.next;
		this.next = null;
		return next;
